...
//   }
   ...
   //else {
    ...
    if (BTDataIn == '1'){
      ...
      // PROGRAM TO DRIVE BACKWARDS
      digitalWrite (LMotor1A, LOW);
      digitalWrite (LMotor2A, HIGH);
      
      digitalWrite (LMotorE, HIGH);
      
      digitalWrite (RMotor3A, LOW);
      digitalWrite (RMotor4A, HIGH);
      
      digitalWrite (RMotorE, HIGH);
    }
    else if (BTDataIn == "F"){
      //PRORAM TO DRIVE FORWARD
      digitalWrite (LMotor1A, HIGH);
      digitalWrite (LMotor2A, LOW);
